...
* **Age of Tanks Warriors: TD War** (CrazyGames) — Turbo Battle (Rapid Food & Fire Rate), Stepped Speedhack
...
* **`NUMPAD 1`** — Primary Game Action (God Mode / Turbo Battle)
* **`NUMPAD 2`** — Secondary Game Action (One-Hit Kill)
