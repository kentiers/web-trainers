/**
 * Chicken Hell - Direct DevTools Console Injector
 *
 * How to use:
 ...
 *    - NUMPAD 2: 999 Free Wheel Spins
 *    - NUMPAD 3: Toggle Turbo Boost
 *    - F11: Cycle Timescale (1x / 2x / 5x)
 */
(function () {
  'use strict';

  console.log('%c[Chicken Hell Trainer Active]', 'color:#00ffff;font-weight:bold;font-size:14px;');
  ...
  function addRings() {
    ...
    console.log('%c[Economy] +999K Gold Rings Injected! (Reload to view)', 'color:#00ff00;');
  }
  ...
  function addSpins() {
    ...
    console.log('%c[Wheel] 999 Free Spins Granted! (Reload to view)', 'color:#00ff00;');
  }
  ...
  window.addEventListener('keydown', (e) => {
    ...
    else if (e.code === 'Numpad2') { e.preventDefault(); addSpins(); }
    else if (e.code === 'Numpad3') { e.preventDefault(); toggleBoost(!boostOn); }
    else if (e.code === 'F11') { e.preventDefault(); cycleSpeed(); }
  }, true);

  console.log('Ready! Hotkeys: NUMPAD 1 (+999K Rings), NUMPAD 2 (999 Spins), NUMPAD 3 (Turbo Boost), F11 (Speed).');
})();
